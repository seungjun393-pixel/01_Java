...
// -> 검색(조회) 효율적
// java.util.Vector : 동기화 제공하여 List중 성능이 가장 좋지않음
...
public class StudentService {
	...
	public void displayMenu() {
		...
		do {	
			try {
				...
				sc.nextLine(); // 입력버퍼 남아있는 잘못된코드 + 개행문자 제거
				
				menuNum = -1; // 첫 반복시 잘못 입력하는 경우
				// menuNum 이 초기값인 0을 가지고있어 반복문이 종료됨.
				// 이를 방지하기 위해 임의값 -1 대입
	...
	public String addStudent() {
		...
		// InputMismatchException , NullPointException...
