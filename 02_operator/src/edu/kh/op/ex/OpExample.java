...
public class OpExample {
	...
	public void testEx1() {
		...
		int b = 5;
		int c = a++ + --b;
		System.out.printf("%d/ %d/ %d",a,b,c); //4 4 7
	...
	public void testEx4() {
		//삼항 연산자 : 조건식 ? ture일때 수행될값 : false일때 수행될값 <- 삼항연산자 식
		...
		System.out.print(input1 >=0 ? "양수입니다." : "음수입니다.");
