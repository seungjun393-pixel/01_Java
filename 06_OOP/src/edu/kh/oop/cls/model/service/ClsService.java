...
public class ClsService {//extends Student// 자식 클래스{
	...
	public void ex2() {
		...
		// schoolName에 노란줄이 뜨는 이유(경고) -> 제대로 작성 안함
		
		
		//*** static 이 붙은 변수(필드)는 '클래스명.변수명' 으로 사용함 ***
		System.out.println( Student.schoolName);
		System.out.println( Student.schoolName2);
	...
	public void ex3() {
		...
		// 왜? -> 같은 기본 생성자로 User 객체를 생성하고있기 때문에
		// 기본생성자에 작성된코드가 똑같이 수행됨.
		
		System.out.println("===============================");
		
		// 해결방법 1 : setter를 이용해서 새로운값 대입
		...
		User u3 = new User("test3","password1234","김영희",25,'여');
	...
	public void ex4() {
		...
		User u3 = new User("user03","pass03","김길동",20,'남'); // 매개변수 5개 생성자(전부 초기화)
