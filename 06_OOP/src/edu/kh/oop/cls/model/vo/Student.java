...
// [접근제한자] [예악어] class 클래스명 {}	
	...
	int v3 = 30;           // (defalut) 같은 패키지내까지 가능
	private int v4 = 40; // 해당클래스 내부에서만 가능
	
	// static 예악어
	public static String schoolName = "KH고등학교";
	public static String schoolName2 = "KH대학교";
	
	// final 예약어
	private final int TEMP1 = 100;
	
	// getter 만 만들어진 이유 : final 예약어가 붙은 상수 TEMP1은 재대입 불가하여
	// setter를 굳이 만들어주지 않음.
	public int getTEMP1() {
		return TEMP1;
	}
	...
	public void ex() {
		...
		// 생성된 변수이기 때문에 v1~v4 전부 직접 접근 가능
