...
public class User {
	...
	// 매개변수 생성자 자동완성
	// atl + s -> Generate Constructor using Fields -> generate 클릭
	...
	public User(String userId, String userPw, String userName, int userAge, char userGender) {
		...
		// 왜 사용?
		// -> 중복코드제거, 코드길이감소, 재사용성 증가
		// 단점 : 가독성이 좀 떨어지는 경우가 있다
		// 주의할점 : 반드시 생성자 내에서 첫번째 줄에 작성해야한다
	...
	// 매개변수의 갯수가 같은것은 있으나, 매개변수중 하나의 타입이 다름
	// -> 오버로딩 성립
